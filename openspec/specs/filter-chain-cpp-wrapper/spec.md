...
## Purpose
Define the public C++ wrapper contract for `goggles-filter-chain`, including typed runtime
operations, retarget behavior, and boundary-safe consumer dependencies.
## Requirements

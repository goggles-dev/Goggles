 ...
 */
static inline bool zwlr_layer_shell_v1_error_is_valid(uint32_t value, uint32_t version) {
    switch (value) {
 ...
 */
static inline bool zwlr_layer_shell_v1_layer_is_valid(uint32_t value, uint32_t version) {
    switch (value) {
 ...
 */
static inline bool zwlr_layer_surface_v1_keyboard_interactivity_is_valid(uint32_t value,
                                                                         uint32_t version) {
    switch (value) {
 ...
 */
static inline bool zwlr_layer_surface_v1_error_is_valid(uint32_t value, uint32_t version) {
    switch (value) {
 ...
 */
static inline bool zwlr_layer_surface_v1_anchor_is_valid(uint32_t value, uint32_t version) {
    uint32_t valid = 0;
    if (version >= 1)
...
struct zwlr_layer_surface_v1_interface {
     ...
     */
    void (*set_size)(struct wl_client* client, struct wl_resource* resource, uint32_t width,
                     uint32_t height);
    /**
     ...
     */
    void (*set_exclusive_zone)(struct wl_client* client, struct wl_resource* resource,
                               int32_t zone);
    /**
     ...
     */
    void (*set_margin)(struct wl_client* client, struct wl_resource* resource, int32_t top,
 ...
 */
static inline void zwlr_layer_surface_v1_send_configure(struct wl_resource* resource_,
 ...
 * @param resource_ The client's resource
 */
static inline void zwlr_layer_surface_v1_send_closed(struct wl_resource* resource_) {
